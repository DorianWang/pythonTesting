"""
SYSC 1005 A Fall 2015 - Using a Dictionary to Implement a Histogram
"""
import string
...
def words_with_frequency(hist, n):
    """
    Returns a list of all words in a dictionary hist that occur with frequency n. The list is sorted in ascending order.
    ...
    """
    a = [word for word in hist.keys() if hist[word] == n]
    a.sort()
    return a
